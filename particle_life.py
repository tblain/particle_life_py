...
for i in range(1, 20):
    list_particle.append(
        Particle(blue, random.randrange(20, 880), random.randrange(20, 980), 10)
    )
    list_particle.append(
        Particle(red, random.randrange(20, 880), random.randrange(20, 980), 10)
    )
    list_particle.append(
        Particle(green, random.randrange(20, 880), random.randrange(20, 980), 10)
    )
    list_particle.append(
        Particle(yellow, random.randrange(20, 880), random.randrange(20, 980), 10)
    )
    list_particle.append(
        Particle(purple, random.randrange(20, 880), random.randrange(20, 980), 10)
    )
    list_particle.append(
        Particle(orange, random.randrange(20, 880), random.randrange(20, 980), 10)
    )
